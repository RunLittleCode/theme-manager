...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [fistNaviController setTitle:@"plist demo"];
    [rootViewController addChildViewController:fistNaviController];
    
    HJNavigationViewController * secondNaviController = [[HJNavigationViewController alloc] initWithRootViewController:[ChangeThemeController new]];
    [secondNaviController setTitle:@"other tab"];
    [rootViewController addChildViewController:secondNaviController];
